...
//     //     flagged: [null, new Validator(({attributeValue}) =>
//     // 'Message ' + attributeValue, nonFatal)],
//     // }),
...
//     //     flagged: [42, new Validator(({attributeValue}) => 'Message '
//     // + attributeValue, nonFatal)],
//     // }),
//     // fatalDynamicNullValidator: Structure.string({
//     //     flagged: [() => null, new Validator(({attributeValue}) => 'Message '
//     //  + attributeValue, nonFatal)],
...
//     //     flagged: [() => 42, new Validator(({attributeValue}) =>
//     // 'Message ' + attributeValue, fatal)],
//     // }),
